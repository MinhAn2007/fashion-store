    ...
    <div className="bg-gray-50 mt-16 flex flex-col md:flex-row pt-10 shadow-lg rounded-lg p-12"> {/* Added shadow and padding */}
      <div className="w-full md:w-1/3 mx-auto md:ml-20 lg:ml-64 relative">
        <img
          ...
          className="w-72"
        />
        <p className="mt-4 text-gray-700 text-xs sm:text-sm md:text-base lg:text-base w-full md:w-96 mr-48 leading-snug">
      ...
      <div className="flex flex-col md:flex-row gap-24 md:justify-end mt-8 md:mt-0 md:mr-44">
        <Link to={`/journal/april`} className="flex flex-col items-center">
          <img
            src={banner2}
            alt="Minimalism"
            className="w-full md:w-96 h-auto rounded-xl shadow-lg" // Add box shadow here
          />
